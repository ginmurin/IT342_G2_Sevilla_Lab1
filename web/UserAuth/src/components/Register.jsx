  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 py-12">
      <div className="mx-auto w-full max-w-xl rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
        ...
        <h1 className="mt-6 text-center text-4xl font-medium text-slate-900">Register</h1>
        <p className="mt-2 text-center text-base text-slate-600">Create your account</p>

        {success && (
          <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-base text-emerald-700">
